...
export default function StreamPage() {
  ...
  const likeMutation = useMutation({
    mutationFn: async () => {
      ...
      try {
        ...
        /* si falla, mantenemos el valor local */
      }
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center football-pattern">
        <div className="text-center animate-fade-in-scale">
          ...
          <p className="text-muted-foreground shimmer">
            Cargando transmisión...
          </p>
          <div className="text-xs text-primary mt-2 animate-pulse">
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
        ...
        >
          <div className="flex items-center justify-between max-w-7xl mx-auto">
              ...
              <div className="flex items-center space-x-2">
                <Tv
                  className={`text-primary w-5 h-5 md:w-6 md:h-6 transition-all duration-300 ${
                    headerHover
                      ? "animate-ball-spin text-gradient-argentina"
                      : ""
                  }`}
                />
                <h1
            ...
            <div className="flex items-center space-x-3">
              ...
              <Button
                onClick={() => {
                  // intenta abrir app de MercadoPago
                  const mpApp = "mercadopago://mpago.la/123456"; // tu link real
                  const mpWeb = "https://mpago.la/123456"; // fallback web
      ...
      <main
        className={`${
          !isFullscreen ? "pt-20 md:pt-28 lg:pt-32" : ""
        } px-2 md:px-4 lg:px-6 pb-6`}
      >
                    ...
                    <div className="space-y-4">
                      <div className="animate-fade-in-scale">
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                          <Badge
                            variant="outline"
                            className="shimmer glow-celeste"
                          >
                          ...
                          <div className="flex items-center">
                            <p
                              className={`font-medium tabular-nums transition-all duration-300 ${
                                showViewerAnimation
                                  ? "text-primary animate-bounce-number"
                                  : ""
                              }`}
                            >
                              {viewerCount}
                      ...
                      <div className="animate-slide-in-up animate-delay-300 enhanced-hover p-3 rounded-lg">
                        <h3 className="font-semibold mb-2 text-gradient-argentina">
                          Información del Canal
                        </h3>
                        <p className="text-sm text-muted-foreground leading-relaxed">
                          ESPN Premium HD Argentina - Transmisión deportiva en
                          alta definición. Disfruta de los mejores eventos
                          deportivos con calidad profesional.
                        </p>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="relative w-[92%] max-w-md rounded-2xl bg-white shadow-2xl p-5 text-center border border-black/5">
            ...
            <div className="mt-4 flex justify-center items-center gap-4">
              <img
                src={tntSportsLogo as string}
                alt="TNT Sports"
                className="h-10 w-auto object-contain drop-shadow-sm"
              />
              <img
                src={espnPremiumLogo as string}
                alt="ESPN Premium"
                className="h-10 w-auto object-contain drop-shadow-sm"
              />
            </div>
